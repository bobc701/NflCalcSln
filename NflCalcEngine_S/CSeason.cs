...
namespace NflCalc {
   ...
   // --------------------------------------------------------------
      ...
      // --------------------------------------------------------
         try { //A comment
            string s;
            using (StringReader f = NflCalcXF.Services.Repository.GetTextFileOnLine("DataDate")) {
               s = f.ReadLine();
               f.Close();
            }
      ...
      // --------------------------------------------------------
         using (StringReader f = NflCalcXF.Services.Repository.GetTextFileOnLine("Spread")) {
      ...
      // --------------------------------------------------------
         using (StringReader f = NflCalcXF.Services.Repository.GetTextFileOnLine("Results")) {
      ...
      public void FillSchedule() {
         // -----------------------------------------------------------
         string sched;
         using (StringReader f = NflCalcXF.Services.Repository.GetTextFileOnLine("Schedule")) {
            sched = f.ReadToEnd();
         }
